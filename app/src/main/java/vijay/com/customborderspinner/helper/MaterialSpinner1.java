...
import vijay.com.customborderspinner.R;

import java.lang.reflect.Method;
import java.util.Arrays;
import java.util.List;

public class MaterialSpinner1 extends TextView {
    ...
    public MaterialSpinner1(Context context) {
        super(context);
        init(context, null);
    }

    public MaterialSpinner1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MaterialSpinner1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (onItemSelectedListener != null) {
                    ...
                    onItemSelectedListener.onItemSelected(MaterialSpinner1.this, position, id, item);
                }
            }
        });
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            popupWindow.setBackgroundDrawable(Utils.getDrawable(context, R.drawable.ms__drawable1));
        } else {
            popupWindow.setBackgroundDrawable(Utils.getDrawable(context, R.drawable.ms__drop_down_shadow1));
        }
        ...
        popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                if (nothingSelected && onNothingSelectedListener != null) {
                    onNothingSelectedListener.onNothingSelected(MaterialSpinner1.this);
                }
                if (!hideArrow) {
                    animateArrow(false);
                }
    ...
    public interface OnItemSelectedListener<T> {
         ...
         * item.</p>
         *
         * @param view     The {@link MaterialSpinner1} view
         * @param position The position of the view in the adapter
         * @param id       The row id of the item that is selected
         * @param item     The selected item
         */
        void onItemSelected(MaterialSpinner1 view, int position, long id, T item);
    }
    ...
    public interface OnNothingSelectedListener {
         ...
         *
         * @param spinner the {@link MaterialSpinner1}
         */
        void onNothingSelected(MaterialSpinner1 spinner);
    }
}
